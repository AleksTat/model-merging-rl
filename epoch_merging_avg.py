...
from merge import weight_averaging
...
def main():
    ...
    print('env_a:', args.env)
    print('env_b:', args.env)
    ...
    venv_a = VecMonitor(venv=venv_a, filename=monitor_path)
    ...
    venv_b = VecMonitor(venv=venv_b, filename=monitor_path)
    ...
    for step in range(1, TOTAL_STEPS+1):
        ...
        if step % MERGE_INTERVALL == 0:
            ...
            updated_params = weight_averaging(model_a.policy.state_dict(), model_b.policy.state_dict(), args.inter_param)
