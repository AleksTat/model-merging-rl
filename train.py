...
def just_train(total_steps, env, seed_init, seed_env, model_save_dir, monitor_path, tb_path):
    ...
    print('Saving model after training to:', model_save_dir)
    print('Monitor files for training are saved to:', monitor_path)
    print('Tensboard files are saved to', tb_path)
