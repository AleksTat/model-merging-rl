...
const std::string NAME = "fruitbot_treats";

const float SURVIVAL_BONUS = 0.05;
const float COMPLETION_BONUS = 10.0;
const int POSITIVE_REWARD = 1.0f;
const int PENALTY = -3.0f;
...
class FruitBotTreatsGame : public BasicAbstractGame {
  public:
    float min_dim = 0.0f;
    ...
    void game_reset() override {
        ...
        int num_bad = rand_gen.randn(24) + 20;
...
REGISTER_GAME(NAME, FruitBotTreatsGame);
